...
### Expensive Lineups Input {data-width=100}
...
selectInput("team1_wk4",label="Team",selected="Man. Utd.", choices = teamsChoice, width=120)
 ...
 output$opp_wk4 <- renderUI({
  ...
  selectInput("opp_wk4",label="Opponents",selected="Man. City", choices = oppTeam,  width=120) 
 })
...
### Expensive Lineups Table - click row for players cost {data-width=100}
...
### Expensive Lineups Chart  {data-width=400}
...
sliderInput("GA_wk5","Minimum Goals Against",min=1,max=9,value=3)
sliderInput("seq_wk5","Minimum Sequence Length",min=1,max=40,value=2)
...
data_wk5()$table_wk5 %>%
 DT::datatable(width=250,
               selection='single',class='compact stripe hover row-border order-column',rownames=FALSE,options= list(paging = TRUE, searching = FALSE,info=FALSE))
