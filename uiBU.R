## old version but works looking to replace withshinydashboard
...
navbarMenu("Goal Summary",
           ...
           tabPanel("Chart",
                ...
                tabPanel("Sequences",
                         ...
                         fluidRow(
                           column(4,DT::dataTableOutput("plBestSeqGl")),
                           column(4,DT::dataTableOutput("plWorstSeqGl"), offset =1)
                ),
                fluidRow(
                ...
                fluidRow(
                  column(6,DT::dataTableOutput("plBestSeqAss")),
                  column(6,DT::dataTableOutput("plWorstSeqAss"))
                )
